...
- `Bitrix frontend component integration` 

**Tools**
- `Git/GitHub` • `Command Line (Bash)`
- `Postman` • `DevTools` • `VS Code`
- `Jira` • `Testing` • `Code documentation`
...
**Bitrix Development:**
- [Bitrix Developer (Diploma)](./certificates/bitrix-developer-diploma.pdf)
- [Bitrix Developer](./certificates/bitrix-developer.pdf)
- [Creating Dynamic Content](./certificates/bitrix-dynamic-content.pdf)
- [Bitrix Installation & Configuration](./certificates/bitrix-installation.pdf)
- [Order Management System](./certificates/bitrix-order-system.pdf)

**Web Development:**
- [HTML Layout](./certificates/html-layout.pdf)
- [Website Development. Address Management](./certificates/address-management-development.jpg)
- [Web Applications Work](./certificates/web-applications-work.pdf)
- [PHP Fundamentals](./certificates/PHP.pdf)
- [Git Version Control System](./certificates/git-version-control.pdf)

**Testing:**
- [Manual Testing of Web Applications](./certificates/manual-testing.pdf)
- [Java for Testers](./certificates/java-testing.pdf)
...
## 📞 Contacts
<p align="center">
  <a href="mailto:vuefanov@yandex.ru"><img src="https://img.shields.io/badge/Email-vuefanov@yandex.ru-0077B5?style=for-the-badge&logo=gmail&logoColor=white" /></a>
  <a href="https://t.me/jonssonv"><img src="https://img.shields.io/badge/Telegram-@jonssonv-0077B5?style=for-the-badge&logo=telegram&logoColor=white" /></a>
</p>
